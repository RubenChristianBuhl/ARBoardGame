 ...
 */
  ...
  * \brief General C-Interface for the vlSDK, which workes on all devices.
  */
/**@{*/

#ifndef VL_UNITY_SDK_H
#define VL_UNITY_SDK_H

#include "vlUnitySDKDef.h"
#include "vlUnitySDKVersion.h"
...
{
    /*! Portrait. */
    VL_SCREEN_ORIENTATION_PORTRAIT = 0,
    /*! Portrait upside-down. */
    VL_SCREEN_ORIENTATION_PORTRAIT_UPSIDE_DOWN = 1,
    /*! Landscape left. */
    VL_SCREEN_ORIENTATION_LANDSCAPE_LEFT = 2,
    /*! Landscape right. */
    VL_SCREEN_ORIENTATION_LANDSCAPE_RIGHT = 3,
} vlScreenOrientation;
...
extern "C"
{
     ...
     */
    VL_SDK_API bool vlGetVersionString(char version[], unsigned int maxSize);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAddLogListener(vlCallbackZString fn, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlRemoveLogListener(vlCallbackZString fn, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlClearLogListeners();
     ...
     */
    VL_SDK_API void vlEnableLogBuffer();
     ...
     * By default log buffering is disabled.
     */
    VL_SDK_API void vlDisableLogBuffer();
     ...
     */
    VL_SDK_API void vlSetLogBufferSize(unsigned int maxEntries);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlFlushLogBuffer();
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlSetLogLevel(int level);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlLog(const char message[], int level);

    /*!
     * \ingroup global
     * \brief Not used right now.
     */
    VL_SDK_API void vlSetScreenOrientation(int screenOrientation);
     ...
     */
    VL_SDK_API vlAbstractApplicationWrapper_t*
     ...
     */
    VL_SDK_API void vlDelete_AbstractApplicationWrapper(
     ...
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_FoundBlockedFeatures(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_ActivateFoundBlockedFeatures(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper);

    /*!
     * \ingroup aap
     * \brief Returns the host ID of the current machine as zero terminated
     *        string.
     *
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_GetHostID(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_SetLicenseFilePath(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_SetLicenseFileData(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_AutoLoadPlugins(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_SetResourcePath(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper,
        const char path[]);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_GetTrackerType(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_ClearProject(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_LoadProjectData(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper,
        const char filename[]);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_LoadProjectDataFromString(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper,
     ...
     *          \c NULL otherwise.
     */
    VL_SDK_API vlActionPipeWrapper_t*
     ...
     *
     * You must call ::vlDelete_DataBaseWrapper function after you are done using
     * the returned object. Failure to do so will result in leaked memory.
     *
     * \param abstractApplicationWrapper Pointer to an
     *        AbstractApplicationWrapper object.
     ...
     *          \c NULL otherwise.
     */
    VL_SDK_API vlDataSetWrapper_t* vlAbstractApplicationWrapper_GetDataSet(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper);
     ...
     *          \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_InitActions(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper);
     ...
     *          \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_ApplyActions(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_RegisterThread(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper);

    /*!
     * \ingroup aap
     * \brief Receives information about the used system.
     *
     * The function returns/fills up a JSON string that allows you finding out a lot
     * about your system used.
     * It also incoorperates the cameras that have been found within the system.
     *
     ...
     * \code{.json}
      ...
      \endcode
     * Please also have a look at [this reference](\ref VLDeviceInfo) for more information.
     * \param abstractApplicationWrapper Pointer to an
     *        AbstractApplicationWrapper object.
     * \param infoJsonString Pointer to an
     *        preallocated space.
     * \param the size of the allocated pointer buffer to the
     *        string.
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlAbstractApplicationWrapper_GetDeviceInfo(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper,
        char infoJsonString[], unsigned int maxSize);

    /*!
     * \ingroup aap
     * \brief Adds a given uri pointing to a camera calibration database.
     *
     * Adds the camera calibration json database to the visionlib in order
     * to allow extending supported devices.
     * Ideally this function is called before loading the tracking configuration.
     *
     * A typical device info might look like this:
     *
     * Please also have a look at [this reference](\ref cameraCalibration) for
     * more information about the cameraDB format.
     *
     * \param abstractApplicationWrapper Pointer to an
     *        AbstractApplicationWrapper object.
     * \param uri String pointing to an uri.
     * \returns \c true, on success; \c false otherwise.
     */

    VL_SDK_API bool vlAbstractApplicationWrapper_AddCameraCalibrationDB(
        vlAbstractApplicationWrapper_t* abstractApplicationWrapper,
        const char cameraDatabaseURI[]);
     ...
     */
    VL_SDK_API void vlDelete_ActionWrapper(vlActionWrapper_t* actionWrapper);
     ...
     */
    VL_SDK_API bool vlActionWrapper_IsEnabled(
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlActionWrapper_SetEnabled(
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlActionWrapper_GetAttribute(
        vlActionWrapper_t* actionWrapper,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlActionWrapper_SetAttribute(
        vlActionWrapper_t* actionWrapper,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlActionWrapper_Init(vlActionWrapper_t* actionWrapper,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlActionWrapper_Apply(vlActionWrapper_t* actionWrapper,
        vlDataSetWrapper_t* dataSetWrapper);
     ...
     */
    VL_SDK_API void vlDelete_ActionPipeWrapper(
     ...
     */
    VL_SDK_API bool vlActionPipeWrapper_IsEnabled(
        vlActionPipeWrapper_t* actionPipeWrapper);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlActionPipeWrapper_SetEnabled(
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlActionPipeWrapper_GetAttribute(
        vlActionPipeWrapper_t* actionPipeWrapper,
        const char attributeName[], char value[],
        unsigned int maxSize);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlActionPipeWrapper_SetAttribute(
        vlActionPipeWrapper_t* actionPipeWrapper,
        const char attributeName[], const char value[]);
     ...
     *          \c NULL otherwise.
     */
    VL_SDK_API vlActionWrapper_t* vlActionPipeWrapper_FindAction(
     ...
     *          \c NULL otherwise.
     */
    VL_SDK_API vlActionPipeWrapper_t* vlActionPipeWrapper_FindActionPipe(
        vlActionPipeWrapper_t* actionPipeWrapper, const char key[]);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlActionPipeWrapper_Init(
        vlActionPipeWrapper_t* actionPipeWrapper,
        vlDataSetWrapper_t* dataSetWrapper);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlActionPipeWrapper_Apply(
        vlActionPipeWrapper_t* actionPipeWrapper,
        vlDataSetWrapper_t* dataSetWrapper);
     ...
     */
    VL_SDK_API void vlDelete_DataBaseWrapper(
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlDataBaseWrapper_GetAttribute(
        vlDataBaseWrapper_t* dataBaseWrapper,
        const char attributeName[], char value[],
        unsigned int maxSize);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlDataBaseWrapper_SetAttribute(
        vlDataBaseWrapper_t* dataBaseWrapper,
        const char attributeName[], const char value[]);
     ...
     */
    VL_SDK_API void vlDelete_DataSetWrapper(
        vlDataSetWrapper_t* dataSetWrapper);
     ...
     *          \c NULL otherwise.
     */
    VL_SDK_API vlDataBaseWrapper_t* vlDataSetWrapper_GetDataBase(
     ...
     *          \c NULL otherwise.
     */
    VL_SDK_API vlDataSetWrapper_t* vlDataSetWrapper_GetDataSet(
        vlDataSetWrapper_t* dataSetWrapper, const char key[]);
     ...
     *          \c NULL otherwise.
     */
    VL_SDK_API vlImageWrapper_t* vlDataSetWrapper_GetImage(
        vlDataSetWrapper_t* dataSetWrapper, const char key[]);
     ...
     *          \c NULL otherwise.
     */
    VL_SDK_API vlExtrinsicDataWrapper_t* vlDataSetWrapper_GetExtrinsicData(
        vlDataSetWrapper_t* dataSetWrapper, const char key[]);
     ...
     *          \c NULL otherwise.
     */
    VL_SDK_API vlIntrinsicDataWrapper_t* vlDataSetWrapper_GetIntrinsicData(
        vlDataSetWrapper_t* dataSetWrapper, const char key[]);
     ...
     */
    VL_SDK_API void vlDelete_ImageWrapper(vlImageWrapper_t* imageWrapper);
     ...
     */
    VL_SDK_API unsigned int vlImageWrapper_GetFormat(
     ...
     */
    VL_SDK_API unsigned int vlImageWrapper_GetBytesPerPixel(
        vlImageWrapper_t* imageWrapper);
     ...
     */
    VL_SDK_API unsigned int vlImageWrapper_GetWidth(
        vlImageWrapper_t* imageWrapper);
     ...
     */
    VL_SDK_API unsigned int vlImageWrapper_GetHeight(
        vlImageWrapper_t* imageWrapper);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlImageWrapper_CopyToBuffer(vlImageWrapper_t* imageWrapper,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlImageWrapper_CopyFromBuffer(
     ...
     */
    VL_SDK_API void vlDelete_ExtrinsicDataWrapper(
     ...
     *          \c false otherwise.
     */
    VL_SDK_API bool vlExtrinsicDataWrapper_GetValid(
        vlExtrinsicDataWrapper_t* extrinsicDataWrapper);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlExtrinsicDataWrapper_GetModelViewMatrix(
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlExtrinsicDataWrapper_GetT(
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlExtrinsicDataWrapper_SetT(
     ...
     *
     * \param extrinsicDataWrapper Pointer to an ExtrinsicDataWrapper object.
     * \param q Float array with 4 elements \f$(x,y,z,w)\f$ for storing the rotation as
     *        quaternion.
     * \param elementCount Number of elements in the given array.
     *        This should be 4.
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlExtrinsicDataWrapper_GetR(
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlExtrinsicDataWrapper_SetR(
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlExtrinsicDataWrapper_GetCamPosWorld(
        vlExtrinsicDataWrapper_t* extrinsicDataWrapper, float t[],
        unsigned int elementCount);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlExtrinsicDataWrapper_SetCamPosWorld(
        vlExtrinsicDataWrapper_t* extrinsicDataWrapper, const float t[],
        unsigned int elementCount);
     ...
     */
    VL_SDK_API void vlDelete_IntrinsicDataWrapper(
     ...
     * \returns The width in pixels.
     */
    VL_SDK_API unsigned int vlIntrinsicDataWrapper_GetWidth(
        vlIntrinsicDataWrapper_t* intrinsicDataWrapper);
     ...
     * \returns The height in pixels.
     */
    VL_SDK_API unsigned int vlIntrinsicDataWrapper_GetHeight(
        vlIntrinsicDataWrapper_t* intrinsicDataWrapper);
     ...
     */
    VL_SDK_API double vlIntrinsicDataWrapper_GetFxNorm(
        vlIntrinsicDataWrapper_t* intrinsicDataWrapper);
     ...
     */
    VL_SDK_API double vlIntrinsicDataWrapper_GetFyNorm(
        vlIntrinsicDataWrapper_t* intrinsicDataWrapper);
     ...
     */
    VL_SDK_API double vlIntrinsicDataWrapper_GetSkewNorm(
        vlIntrinsicDataWrapper_t* intrinsicDataWrapper);
     ...
     */
    VL_SDK_API double vlIntrinsicDataWrapper_GetCxNorm(
        vlIntrinsicDataWrapper_t* intrinsicDataWrapper);
     ...
     */
    VL_SDK_API double vlIntrinsicDataWrapper_GetCyNorm(
        vlIntrinsicDataWrapper_t* intrinsicDataWrapper);
     ...
     *          \c false otherwise.
     */
    VL_SDK_API bool vlIntrinsicDataWrapper_GetCalibrated(
        vlIntrinsicDataWrapper_t* intrinsicDataWrapper);
     ...
     */
    VL_SDK_API double vlIntrinsicDataWrapper_GetCalibrationError(
        vlIntrinsicDataWrapper_t* intrinsicDataWrapper);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlIntrinsicDataWrapper_GetRadialDistortion(
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlIntrinsicDataWrapper_SetRadialDistortion(
     ...
     * \param screenOrientation Orientation of the screen. Use values of the
     *        ::vlScreenOrientation enumeration.
     *        We assume, that the camera calibration was done with images in
     *        portrait mode. Therefore usually ::VL_SCREEN_ORIENTATION_PORTRAIT
     *        should be used for screen which can't be rotated.
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlIntrinsicDataWrapper_GetProjectionMatrix(
        vlIntrinsicDataWrapper_t* intrinsicDataWrapper,
        float nearFact, float farFact, unsigned int screenWidth,
        unsigned int screenHeight, unsigned int screenOrientation,
     ...
     *          avoid memory leaks.
     */
    VL_SDK_API vlWorker_t* vlNew_Worker(vlAbstractApplicationWrapper_t* aap);
     ...
     */
    VL_SDK_API vlWorker_t* vlNew_SyncWorker(
     ...
     */
    VL_SDK_API void vlDelete_Worker(vlWorker_t* worker);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_Start(vlWorker_t* worker);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_Stop(vlWorker_t* worker);
     ...
     * \returns \c true, on success; \c false, otherwise.
     */
    VL_SDK_API bool vlWorker_RunOnceSync(vlWorker_t* worker);
    ...
    * \returns \c true, on success; \c false, otherwise.
    */
    VL_SDK_API bool vlWorker_ProcessJsonCommandSync(vlWorker_t* worker, const char jsonString[], vlCallbackJsonString callback, void* clientData);
     ...
     *          \c NULL otherwise.
     */
    VL_SDK_API vlImageWrapper_t* vlWorker_GetImageSync(vlWorker_t* worker);
    ...
    *          \c NULL otherwise.
    */
    VL_SDK_API vlImageWrapper_t* vlWorker_GetImageByNameSync(vlWorker_t* worker, const char* image_name);
     ...
     */
    VL_SDK_API bool vlWorker_IsRunning(vlWorker_t* worker);
     ...
     *          \c false otherwise.
     */
    VL_SDK_API bool vlWorker_PushCommand(vlWorker_t* worker,
        const char name[], const char parameter[], vlCallbackBool callback,
        void* clientData);
     ...
     *          \c false otherwise.
     */
    VL_SDK_API bool vlWorker_PushJsonCommand(vlWorker_t* worker,
        const char jsonString[], vlCallbackJsonString callback, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_ProcessCallbacks(vlWorker_t* worker);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_AddImageListener(vlWorker_t* worker,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_RemoveImageListener(vlWorker_t* worker,
        vlCallbackImageWrapper listener, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_AddExtrinsicDataListener(vlWorker_t* worker,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_RemoveExtrinsicDataListener(vlWorker_t* worker,
        vlCallbackExtrinsicDataWrapper listener, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_AddIntrinsicDataListener(vlWorker_t* worker,
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_RemoveIntrinsicDataListener(vlWorker_t* worker,
        vlCallbackIntrinsicDataWrapper listener, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_AddTrackingStateListener(vlWorker_t* worker,
        vlCallbackZString listener, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_RemoveTrackingStateListener(vlWorker_t* worker,
        vlCallbackZString listener, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_AddPerformanceInfoListener(vlWorker_t* worker,
        vlCallbackZString listener, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_RemovePerformanceInfoListener(vlWorker_t* worker,
        vlCallbackZString listener, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_AddNamedImageListener(vlWorker_t* worker,
        const char key[], vlCallbackImageWrapper listener, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_RemoveNamedImageListener(vlWorker_t* worker,
        const char key[], vlCallbackImageWrapper listener, void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_AddNamedExtrinsicDataListener(vlWorker_t* worker,
        const char key[], vlCallbackExtrinsicDataWrapper listener,
        void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_RemoveNamedExtrinsicDataListener(vlWorker_t* worker,
        const char key[], vlCallbackExtrinsicDataWrapper listener,
        void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_AddNamedIntrinsicDataListener(vlWorker_t* worker,
        const char key[], vlCallbackIntrinsicDataWrapper listener,
        void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_RemoveNamedIntrinsicDataListener(vlWorker_t* worker,
        const char key[], vlCallbackIntrinsicDataWrapper listener,
        void* clientData);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_PollEvents(vlWorker_t* worker);
     ...
     * \returns \c true, on success; \c false otherwise.
     */
    VL_SDK_API bool vlWorker_WaitEvents(vlWorker_t* worker, unsigned int timeout);

    /*!
     * \ingroup worker
     * \brief For testing purposed. Don't use!
     */
    VL_SDK_API bool vlWorker_Lock(vlWorker_t* worker);

    /*!
     * \ingroup worker
     * \brief For testing purposed. Don't use!
     */
    VL_SDK_API bool vlWorker_Unlock(vlWorker_t* worker);
     ...
     */
     VL_SDK_API unsigned char* vlSDKUtil_get(
     ...
     * \returns \c true, on success; \c false, otherwise.
     */
     VL_SDK_API bool vlSDKUtil_set(const char* uri, void *data,
        unsigned long size,const char *options=0);
     ...
     * \returns \c true, on success; \c false, otherwise.
     */
     VL_SDK_API bool vlSDKUtil_getTempFilename(const char* prefName,
        char *newName, unsigned int maxSize);
#ifdef __cplusplus
}
#endif // __cplusplus
